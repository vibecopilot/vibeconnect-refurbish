...
const CopyChecklistPPM = () => {
  ...
  if (error || !prefillData) {
    return (
      <div className="p-6 flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <button
          onClick={() => navigate("/asset/ppm-checklist")}
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <ChecklistCreateForm checklistType="ppm" prefillData={prefillData} prefillMode="copy" />
    </div>
  );
};

export default CopyChecklistPPM;

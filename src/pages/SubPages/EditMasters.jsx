...
import { getSiteAsset, postMasters, getAssetGroups,
  getAssetSubGroups, 
  UpdateMasters,
  getMastersDetails} from "../../api";
...
useEffect(() => {
  const fetcMasterDetails = async () => {
    ...
    expiry_date: dateFormat(data.expiry_date),
...
const handleMasters = async() => {
  ...
  sendData.append("inventory[inventory_type]", InventoryType === "spares" ? 1 : 2);
  sendData.append("inventory[site_id]", siteId);
  sendData.append("inventory[criticality]", criticalvalue === "critical" ? 1 : 2);
  ...
  return (
    <div className="flex ">
      ...
      <div className="md:p-4 w-full my-2 flex md:mx-2 overflow-hidden flex-col">
        ...
        <h2 className="text-center md:text-xl font-bold p-2 rounded-md text-white" style={{ background: themeColor }}>
          Edit Masters
        </h2>
        ...
        <label htmlFor="nonCritical">Non Critical</label>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <option value="">Non Technical</option></select>
              </div>

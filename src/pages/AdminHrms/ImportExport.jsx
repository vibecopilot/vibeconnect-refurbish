...
const ImportExport = () => {
  ...
  const data = [
    {
      Name: "person 1",
      Location: "Roster Upload",
      City: "10-07-2024 - 15:37:12 IST",
      State: "Mittu Panda",
      Label:"July-2024",
      Country:"India",
      type:"Import",
    ...
    {
      Name: "person 1",
      Location: "New employee download",
      City: "11-07-2024 - 19:23:51 IST",
      State: "John Doe",
      Label:"July-2024",
      Country:"India",
      type:"Export",
    ...
    <section className="flex gap-3 ml-20">
     <ReportDetailsList/>
      <div className=" w-full flex m-3 flex-col overflow-hidden">
        ...
        <p className="font-bold mb-4">Import Export</p>

...
import PendingReports from "../Expenses/PendingReports";
import CompletedReports from "../Expenses/CompletedReports";
import { MdKeyboardArrowDown } from "react-icons/md";
import PendingBenefits from "./PendingBenefits";
import CompletedBenefits from "./CompletedBenefits";
    ...
    <div className="flex">
      ...
      <div className="ml-20 flex w-full">
        ...
        <div className=" w-full my-2 flex  overflow-hidden flex-col">
          ...
          {page === "Completed" && <CompletedBenefits />}
        </div>
      </div>
      {/* </div> */}
    </div>

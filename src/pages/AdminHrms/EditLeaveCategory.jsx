...
function AddLeaveCategory() {
  ...
  useEffect(() => {
    const fetchLeaveCategoryDetails = async () => {
      try {
        const res = await getLeaveCategoryDetails(id);
        setFormData({
          ...formData,
          leaveType: res.type_of_leave,
          customLabel: res.label,
          abbreviationLabel: res.abbreviation,
          accrualPeriod: res.accrual_period,
          accrueInAdvance: res.accrue_in_advance,
          carryoverLimit: res.carryover_limits,
          negativeBalance: res.negative_balance_allowed,
          roundOffAccrual: res.round_off_to_nearest_half,
          intraCycleLapse: res.intra_cycle_lapse_applicable,
          prorationMethod: res.prorate_first_month_accrual,
          allowWeeklyOff: res.allow_on_weekly_offs,
          canApplyLeave: res.employee_can_apply,
          applyFutureLeave: res.allow_future_leave,
          leaveEncashmentRollover: res.eligible_for_encashment_rollover,
          leaveEncashmentFNF: res.eligible_for_encashment_fnf,
          halfDayOption: res.half_day_option,
          includeHolidayPrefixSuffix: res.include_annual_holiday_prefixed,
          includeAnnualHolidayPart: res.include_annual_holiday_part,
          includeWeeklyOffPrefixed: res.include_weekly_off_prefixed,
          includeWeeklyOffPart: res.include_weekly_off_part,
          paidLeave: res.is_paid_leave,
          minApplicationDaysBefore: res.min_application_days_before,
          maxDaysFromOccurrence: res.max_days_from_occurrence,
          minConsecutiveDays: res.min_consecutive_days_allowed,
          maxConsecutiveDays: res.max_consecutive_days_allowed,
          consecutiveWithWeeklyOff: res.consecutive_with_weekly_off,
          consecutiveWithHoliday: res.consecutive_with_holiday,

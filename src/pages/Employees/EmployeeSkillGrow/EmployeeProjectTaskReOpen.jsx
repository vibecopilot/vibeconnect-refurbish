...
function EmployeeProjectTaskReOpen() {
      ...
      <div className="w-full flex flex-col overflow-hidden">
                  ...
                  return (
                    <tr className="hover:bg-gray-100" key={index}>
                      <td className="px-6 py-4 border-b border-gray-200 text-gray-500 whitespace-nowrap">
                          <button
                            onClick={() =>
                              setReOpenTaskModal(!reOpenTaskModal)
                            }
                          >
        ...
        {reOpenTaskModal && (
          ...
          <div className="bg-white p-5 rounded-lg shadow-lg w-2/5 relative h-3/4 overflow-y-auto hide-scrollbar">
            <button
              onClick={() => setReOpenTaskModal(!reOpenTaskModal)}
            ...
            <div className="flex justify-between">
              ...
              <div className="flex items-center">
                <button
                  className="bg-black text-white p-1 px-3 rounded-md text-sm"
...
export default EmployeeProjectTaskReOpen;

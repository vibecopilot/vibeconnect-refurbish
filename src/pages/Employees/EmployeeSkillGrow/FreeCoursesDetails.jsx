      ...
      <div className='w-full flex flex-col overflow-hidden'>
        <div className="flex my-2 w-full bg-gray-100">
          <div className='mx-5 my-5 w-full'>
            ...
            <h2 className="text-right font-medium "><span className="rounded-full border px-4 p-1 text-green-600 bg-green-400 bg-opacity-30 border-green-600">Level 3</span></h2>
            </div>

...
function EmployeeProjectTaskOverDue() {
  const [dueDateTaskModal, setDueDateTaskModal] = useState(false);
  ...
  const projectTasks = [
    {
      id: 1,
      tasks: "DataBase",
      startDate: "2 july 2024",
      endDate: "18 july 2024",
      delayDate: "20 july 2024",
      status: "Over Due",
      progress: "80%",
      assignee: profile1,
    },
    ...
    {
      id: 4,
      tasks: "Graphic with company Logo & Photo",
      startDate: "10 july 2021",
      endDate: "15 july 2021",
      delayDate: "18 july 2021",
      status: "Over Due",
      progress: "100%",
      assignee: profile3,
    },
    ...
    <section className="flex">
      <div className="w-full flex flex-col overflow-hidden">
        <div className="mx-5 mt-5">
          <div className="shadow-custom-all-sides rounded-md mb-4">
            ...
            <div className="overflow-x-auto p-4">
              <table className="w-full bg-white border-gray-200 p-4">
                <thead>
                  <tr>
                    ...
                    return (
                      <tr className="hover:bg-gray-100" key={index}>
                        <td className="px-6 py-4 border-b border-gray-200 text-gray-500 whitespace-nowrap">
                          <button
                            onClick={() =>
                              setDueDateTaskModal(!dueDateTaskModal)
                            }
                          >
                        ...
                        <td className="px-6 py-4 border-b border-gray-200 text-gray-500 whitespace-nowrap"></td>
                      </tr>
                    );
                  })}
                </tbody>
        ...
        {dueDateTaskModal && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-20">
            <div className="bg-white p-5 rounded-lg shadow-lg w-2/5 relative h-3/4 overflow-y-auto hide-scrollbar">
              <button
                onClick={() => setDueDateTaskModal(!dueDateTaskModal)}
              ...
              <div className="flex justify-between">
                ...
                <div className="flex items-center">
                  <button
                    className="bg-yellow-100 text-yellow-400 p-1 px-3 rounded-md text-sm"
...
export default EmployeeProjectTaskOverDue;

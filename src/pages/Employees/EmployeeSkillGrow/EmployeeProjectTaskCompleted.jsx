...
function EmployeeProjectTaskCompleted() {
  ...
  const projectTasks = [
    ...
    {
      id: 4,
      tasks: "Login & Sign-Up Backend",
      startDate: "14 july 2021",
      endDate: "15 july 2021",
      status: "Completed",
      progress: "100%",
      assignee: profile2,
                    ...
                    return (
                      <tr className="hover:bg-gray-100" key={index}>
                        <td className="px-6 py-4 border-b border-gray-200 text-gray-500 whitespace-nowrap">
                          <button
                            onClick={() => setCompleteModal(!completeModal)}
                          >
                ...
                <div className="bg-white p-5 rounded-lg shadow-lg w-2/5 relative h-3/4 overflow-y-auto hide-scrollbar">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center">
                      <button
                        className="bg-green-100 text-green-400 p-1 px-3 rounded-md text-sm"
                  ...
                  <div className="my-3">
                    <div className="flex gap-3">
                      ...
                      <button
                        className={`px-4 py-1 text-black rounded-md border-2 border-violet-100 ${
                          open === "Chat"
                            ? "text-white border-b bg-violet-700"
                            : ""
                        }`}
                      ...
                      <div>
                        <div className="my-3">
                          ...
                          <div className="flex">
                            ...
                            />
                            <label className="flex items-center text-gray-600 text-base">
                              Identify three distinct aesthetic styles for
                              boards
                            </label>
                          </div>
                          {subTask && (
...
export default EmployeeProjectTaskCompleted;

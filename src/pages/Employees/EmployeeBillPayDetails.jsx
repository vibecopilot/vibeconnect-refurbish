...
function EmployeeBillPayDetails() {
  return (
        ...
        <div className="flex justify-center">
          <div className="border-2 border-gray-400 rounded-md md:w-3/5">
            ...
            <div className="md:grid grid-cols px-5 py-5">
              ...
              <h2 className="text-xl font-semibold my-1">
                Name on card :
                <span className="text-base font-normal ml-5">Raj</span>
              </h2>
              <h2 className="text-xl font-semibold my-1">
                Expiry date :
                <span className="text-base font-normal ml-5">2025 Feb</span>
              </h2>
              <h2 className="text-xl font-semibold my-1">
                CVV code :
                <span className="text-base font-normal ml-5">****</span>
              </h2>
              <h2 className="text-xl font-semibold my-1">
                Issuing Bank:
                <span className="text-base font-normal ml-5"></span>
...
export default EmployeeBillPayDetails;

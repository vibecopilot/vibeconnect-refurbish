...
const EmployeeCreateVisitor = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full p-4">
      <form className="border border-gray-300 rounded-lg p-4 w-full mx-4  my-5 ">
          ...
          <div className="flex flex-col md:flex-row gap-5">
            <p
              className={`border-2 p-1 px-6 border-black font-medium rounded-full cursor-pointer ${
                behalf === "Visitor" && "bg-black text-white"
              }`}
            ...
            <p
              className={`border-2 p-1 px-6 border-black font-medium rounded-full cursor-pointer ${
                behalf === "Delivery" && "bg-black text-white"
              }`}
            ...
            <p
              className={`border-2 p-1 px-6 border-black font-medium rounded-full cursor-pointer ${
                behalf === "Cab" && "bg-black text-white"
              }`}
...
export default EmployeeCreateVisitor;

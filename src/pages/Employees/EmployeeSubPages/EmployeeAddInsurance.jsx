    ...
    <section className="min-h-screen p-4 sm:p-0 flex flex-col md:flex-row">
      ...
      <div className="flex justify-center my-5 overflow-x-auto w-full sm:w-full">
        <div className="border border-gray-300 rounded-lg w-full mx-5 p-8 flex flex-col mb-5 gap-5">
          ...
          <Link to={"/employee/add-policy/policy-list"} className="border-2 rounded-md border-black p-1 px-4 font-medium hover:bg-black hover:text-white transition-all duration-300 ease-in-out">
            Next
          </Link>
          </div>
        </div>
...
export default EmployeeAddInsurance;

      ...
      <div className="w-full flex flex-col overflow-hidden">
        ...
        <div className="my-4">
          <div className="flex justify-center mb-5">
            <div className="flex justify-center items-center bg-gray-100 rounded-md w-4/5 h-32">
              <div className="">
                <div className="flex justify-center">
                  <NavLink
                    to={"/admin/skill-grow/edit-course-details"}
                    className={({ isActive }) =>
                      `p-1 ${
                        isActive &&
              ...
              <div className="">
                <div className="flex justify-center">
                  <NavLink
                    to={"/admin/skill-grow/edit-course-description"}
                    className={({ isActive }) =>
                      `p-1 ${
                        isActive &&
                        "bg-blue-500 text-white"
              ...
              <div className="">
                <div className="flex justify-center">
                  <NavLink
                    to={"/admin/skill-grow/edit-curriculum"}
                    className={({ isActive }) =>
                      `p-1 ${
                        isActive &&
                        "bg-blue-500 text-white"

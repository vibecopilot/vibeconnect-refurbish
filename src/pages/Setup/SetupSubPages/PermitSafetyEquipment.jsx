...
import {
  ...
  editPermitRisks,
  deletePermitRisks,
  postPermitSafetyEquipment,
  getPermitSafetyEquipment,
  getPermitSafetyEquipmentDetails,
  editPermitSafetyEquipment,
  deletePermitSafetyEquipment,
} from "../../../api";
...
const PermitSafetyEquipment = () => {
  ...
  const handleSubmit = async () => {
    ...
    sendData.append(
      "permit_safety_equipment[permit_type_id]",
      formData.permit_type_id
    );
    sendData.append(
      "permit_safety_equipment[activity_id]",
    ...
    sendData.append(
      "permit_safety_equipment[hazard_category_id]",
      formData.hazard_category_id
    );
    sendData.append(
      "permit_safety_equipment[permit_risk_id]",
      formData.permit_risk_id
    );

    sendData.append(
      "permit_safety_equipment[safety_equipment_name]",
      formData.name
    );

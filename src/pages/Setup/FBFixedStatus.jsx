...
import { editGenericCategoryDetails, getCuisinesFBSetup, getFixedStatusSetup, getGenericCategoryDetails, getGenericCategoryRestaurtant, postGenericCategory } from "../../api";
import {
...
const FBFixedStatus = () => {
  ...
  const handleCreateCategory = async () => {
    ...
    sendData.append("generic_info[info_type]", "FixedStatus");
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white w-70 h-70 rounded-lg shadow-lg p-4 relative z-10">
            ...
            <h2 className="text-xl font-semibold mb-4">Add Fixed Status</h2>
       ...
       {isModalOpen1 && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white w-70 h-70 rounded-lg shadow-lg p-4 relative z-10">
            ...
            <h2 className="text-xl font-semibold mb-4">Edit Fixed Status</h2>
            <div className="flex flex-col gap-4">
              <div className="mb-4">
                <label className="block text-gray-700 text-medium font-bold mb-2" htmlFor="category-name">
                Status

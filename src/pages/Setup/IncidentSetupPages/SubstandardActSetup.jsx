...
const SubstandardActSetup = () => {
  ...
  const handleAddItem = async () => {
    ...
    const payload = {
      name: name,
      active: true,
      tag_type: "IncidentSubstandardAct",
    ...
    try {
      ...
      // toast.success("Substandard Act created successfully!");
      // fetchItems();
      // setName("");
      // setAddItem(false);
      ...
      console.log(error);
      toast.error("Failed to create Substandard Act");
    }
  };
  ...
  const handleDeleteItem = async (id) => {
    try {
      ...
      // toast.success("Substandard Act deleted successfully");
      // fetchItems();
      ...
      console.log(error);
      toast.error("Failed to delete Substandard Act");
    }
  };
  ...
  const fetchItems = async () => {
    try {
      // TODO: Replace with actual API call
      // const res = await getIncidentTags("IncidentSubstandardAct");
      // setItems(res.data);
        ...
        <div className="flex justify-end">
          {addItem && (
            <div className="flex items-center gap-2 w-full">
              <input
                type="text"
                placeholder="Substandard Act Name"
...
export default SubstandardActSetup;

...
const CorrectiveActionSetup = () => {
  ...
  const handleAddItem = async () => {
    ...
    const payload = {
      name: name,
      active: true,
      tag_type: "IncidentCorrectiveAction",
  ...
  const fetchItems = async () => {
    try {
      // TODO: Replace with actual API call
      // const res = await getIncidentTags("IncidentCorrectiveAction");
      // setItems(res.data);
...
export default CorrectiveActionSetup;

...
const PreventiveActionSetup = () => {
  ...
  const handleAddItem = async () => {
    ...
    const payload = {
      name: name,
      active: true,
      tag_type: "IncidentPreventiveAction",
    ...
    try {
      ...
      // toast.success("Preventive Action created successfully!");
      // fetchItems();
      // setName("");
      // setAddItem(false);
      ...
      console.log(error);
      toast.error("Failed to create Preventive Action");
    }
  };
  ...
  const handleDeleteItem = async (id) => {
    try {
      ...
      // toast.success("Preventive Action deleted successfully");
      // fetchItems();
      ...
      console.log(error);
      toast.error("Failed to delete Preventive Action");
    }
  };
  ...
  const fetchItems = async () => {
    try {
      // TODO: Replace with actual API call
      // const res = await getIncidentTags("IncidentPreventiveAction");
      // setItems(res.data);
        ...
        <div className="flex justify-end">
          {addItem && (
            <div className="flex items-center gap-2 w-full">
              <input
                type="text"
                placeholder="Preventive Action Name"
...
export default PreventiveActionSetup;
